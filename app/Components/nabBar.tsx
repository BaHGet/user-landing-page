...
const NavBar = () => {
    return (
        <aside className="w-13 md:w-1/6 h-screen block" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                <ul className="space-y-2 font-medium">
                    <li>
                        <div className="flex w-fit items-center p-2 text-gray-900 rounded-lg dark:text-white ">
                        ...
                        <span className="ms-3 hidden md:block">Dashboard</span>
                        </div>
                    </li>
                    <li>
                        <Link href="login" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="flex-1 ms-3 hidden md:block">Login</span>
                        </Link>
                    </li>
                    <li>
                        <Link href="profile" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="ms-3 hidden md:block">Profile</span>
                        </Link>
                    </li>
                </ul>
            </div>
